...
class Plume(object):
    ...
    def get_point_cloud_as_msg(self, stamp=None):
        ...
        if self._pnts is None:
            return None
        pc.points = [Point32(x=x, y=y, z=z) for x, y, z in zip(self.x, self.y, self.z)]
    ...
    def get_point_cloud2_as_msg(self, stamp=None):
        if self._pnts is None or self._time_creation is None:
            return None
    ...
    def get_markers(self, stamp=None):
        ...
        source_marker.header.stamp = stamp
        ...
        limits_marker.header.stamp = stamp
        ...
        limits_marker.pose.orientation.x = 0.0
        limits_marker.pose.orientation.y = 0.0
        limits_marker.pose.orientation.z = 0.0
        limits_marker.pose.orientation.w = 0.0
        marker_array.markers.append(limits_marker)

        # Creating marker for the current velocity vector
        cur_vel_marker = Marker()
        cur_vel_marker.header.stamp = stamp
